...
public abstract class ChartFactory {
    ...
    public static JFreeChart createStackedAreaChart(String title,
            String categoryAxisLabel, String valueAxisLabel,
            CategoryDataset dataset) {
        return createStackedAreaChart(new CreateStackedAreaChartParameter4(new CreateStackedAreaChartParameter2(title, true), dataset, PlotOrientation.VERTICAL), categoryAxisLabel, valueAxisLabel,
                true, false);
    }
     ...
     * @return A stacked area chart.
     */
    public static JFreeChart createStackedAreaChart(CreateStackedAreaChartParameter4 parameterObject4,
            String categoryAxisLabel, String valueAxisLabel,
            boolean tooltips, boolean urls) {
